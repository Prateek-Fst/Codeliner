  ...
  return (
    ...
    >
      ...
      <Box className="flex items-start gap-[50.7px] max-w-full shrink-0 mq800:gap-[25px] mq1350:flex-wrap">
        ...
        <Box className="flex items-start gap-[34px] max-w-full mq1125:flex-wrap mq1125:min-w-full mq450:gap-[17px] mq1350:flex-1">
            ...
            <Box className="flex flex-col items-start gap-4">
              ...
              <Box className="flex flex-col items-start gap-2.5">
                <Box className="flex items-center gap-3.5">
                  <div className="w-[136.5px] relative leading-[130%] inline-block shrink-0 opacity-[0.7]">
                    Core Banking CB7
                  </div>
                  <img
      ...
      <Box className="flex items-start !pt-0 !pb-0 !pl-[490px] !pr-16 shrink-0 text-sm text-[rgba(233,244,249,0.3)] mq800:!pl-[122px] mq800:box-border mq450:!pl-5 mq450:box-border mq1350:!pl-[245px] mq1350:!pr-8 mq1350:box-border">
        <div className="h-9 w-[779.4px] relative leading-[130%] inline-block shrink-0 z-[1]">
